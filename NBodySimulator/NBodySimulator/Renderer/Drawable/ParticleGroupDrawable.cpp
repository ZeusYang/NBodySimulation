#include "ParticleGroupDrawable.h"

#include <iostream>

namespace Renderer
{
	ParticleGroupDrawable::ParticleGroupDrawable(bool motionBlur, unsigned int posChannel)
	...
	ParticleGroupDrawable::~ParticleGroupDrawable()
	{
	...
	void ParticleGroupDrawable::setParticleRadius(float radius)
	{
		m_particleRadius = radius;
	}

	void ParticleGroupDrawable::setPositions(std::vector<glm::vec4>& position)
	{
		m_posChannel = 4;
	...
	void ParticleGroupDrawable::setPositions(std::vector<glm::vec3> &position)
	{
		m_posChannel = 3;
		m_vboCreateBySelf = true;
		m_numParticles = position.size();
	...
	void ParticleGroupDrawable::setParticleVBO(unsigned int vbo, int numParticles)
	{
		m_vboCreateBySelf = false;
		m_particleVBO = vbo;
	...
	void ParticleGroupDrawable::render(Camera3D::ptr camera, Light::ptr sunLight,
	...
	void ParticleGroupDrawable::renderDepth(Shader::ptr shader, Camera3D::ptr lightCamera)
	{
		return;
	}

	void ParticleGroupDrawable::generateGaussianMap(int resolution)
	{
